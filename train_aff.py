...
if __name__ == '__main__':
    ...
    pyutils.Logger(os.path.join(args.workdir,args.session_name + '.log'))
...
#             print(bg_label.shape)
            ...
            if (optimizer.global_step - 1) % 500 == 0:   
                ...
                torch.save(model.module.state_dict(), os.path.join(args.workdir,args.session_name + '.pth'))
